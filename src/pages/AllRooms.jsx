        ...
        <div className= 'flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 x1:px-32'>
          <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='font-playfair text-4xl md:text-[40px]'> Take advantage of our limites-time offers and special packages to 
               ...
               {roomsDummyData.map((room)=>(
                <div  key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b
                    ...
                    src={room.images[0]} alt="hotel-img" title='View Room Details' className='max-h-65 md:w-1/2 
