...
const AddRoom=()=>{
    ...
    return(
        <form>
            ...
            details carefully and accurate room details, pricicng, and amenities, to
                ...
                {Object.keys(images).map((key)=>(
                    <label htmlFor={`roomImage${key}`} key={key}>
                        <img className='max-h-13 cursor-pointer opacity-80'
                         ...
                         <input type="file" accept='image/*' id={`roomImage${key}`} hidden onChange={e=>setImages(
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                <div className='flex-1 max-w-48'>
                    ...
                    className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
                        ...
                        <option value="Single Bed">Select Bed</option>
